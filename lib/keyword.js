...
exports.db = [
  ...
  },
  {
    name: '代码质量', children: [
      ...
      {
        name: 'flash',
        alias: ['dreamweaver', 'ie6', 'div+css'],
        score: -1.5
      },
      {
        name: 'jquery',
        alias: ['jq', 'zepto', 'ajax', 'jsonp', 'gulp', 'bootstrap', 'dom', 'requirejs', 'grunt', 'vsn'],
        score: -1
      },
      {
        name: '积极乐观',
...
var Tree = /** @class */ (function () {
  ...
  Tree.prototype.work = function (workDate) {
    this.walked.forEach(function (keywordItem) {
      ...
      var kws = keywordItem.alias.concat(keywordItem.name).map(v => /^[^\x00-\xff]$/.test(v) ? v : `\\b${v}\\b`).join('|');
